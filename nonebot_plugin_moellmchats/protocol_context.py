    ...
    def disabled(
        ...
        *,
        ...
        cache_digest = _snapshot_cache_digest(
            ...
            has_reply_message_id=reply_message_id is not None,
...
def _snapshot_cache_digest(
    *,
    ...
    value = {
        ...
        "has_reply_message_id": has_reply_message_id,
        "implementation": implementation,
        "implementation_version": implementation_version,
        "is_superuser": is_superuser,
        "protocol": protocol,
    ...
    *,
    ...
    try:
        ...
        cache_digest = _snapshot_cache_digest(
            ...
            guild_id=normalized.guild_id,
            channel_id=normalized.channel_id,
            has_message_id=normalized.message_id is not None,
            has_reply_message_id=normalized.reply_message_id is not None,
            generation=generation,
            enabled=True,
        )
