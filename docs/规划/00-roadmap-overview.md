...
- ToolProvider、Repository 接口、engine、离线迁移、Schema、G-01 Chat History Repository 与 G-02 Memory/Redis History Hot Cache primitive 均已完成精确 HEAD 远端双 gate；G-03 依赖已解除
