...
> 进度注记（2026-08-20）：Plan 1 的 Milestone A、B 与 C-01～C-07 已按依赖顺序实现并完成发布门禁。修复后精确 HEAD `f6c7628025cb5d34519499d86b979de448406d5b` 的 push run `32396257506` 与 PR run `32396261932` 各有 11 个成功 job、恰好一个成功 `release-gate`；PR 基分支 `feat/llm-runtime-backpressure` 已要求 `strict=true` 的 `release-gate`。未合并、未 promotion、未部署。Plan 2 的 D-01a、D-02、D-01b、D-03、D-04、D-05、D-05a、D-05b 与 D-06 已完成精确 HEAD 远端门禁；D-07 Capability Policy Merge 实现提交 `c2ca76332b9bfa97fadc7fc8f994b50b7e44dfdd` 已完成本地发布门禁，待 push/PR 双 run 远端 gate，D-08 尚未开始。D-07 将 requested / detected / admin / effective 固化为版本化 capability contract，新增结构化 allowlist、filesystem/database/bot 权限及 `moellm-tool-artifact-v2` 摘要域；`detected` 只约束、不授予权限，v1 artifact/sidecar 继续有界兼容。Provider catalog schema v3 发布不可变 capability policy 索引；D-08 前当前 runner 对 scoped/new rights 明确 fail closed，全部 consumer 与真实执行语义仍保持 legacy 路径。未合并、未 promotion、未发布、未部署。逐项证据见 [Plan 1 完成审计](./05-plan1-completion-audit.md) 与 [实施 Backlog](./04-implementation-backlog.md)。
